...
public class TesteCampoTreinamento {
	...
	public void CombosMultiplos() {
        ...
        List<String> opçoesMarcadas = dsl.obterValoresCombo("elementosForm:esportes");
        Assert.assertEquals(3, opçoesMarcadas.size());
        dsl.deselecionarCombo("elementosForm:esportes","Corrida");
        opçoesMarcadas = dsl.obterValoresCombo("elementosForm:esportes");
        Assert.assertEquals(2, opçoesMarcadas.size());
        Assert.assertTrue(opçoesMarcadas.containsAll(Arrays.asList("Natacao","O que eh esporte?")));
	}
